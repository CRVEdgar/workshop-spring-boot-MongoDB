...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null,formatacao.parse("21/03/2018"),"Partiu Viagem", "Vou viajar para Sao Paulo, abracos", maria);
        Post post2 = new Post(null, formatacao.parse("23/08/2018"), "Bom dia", "Acordei feliz hoje!", maria);
